...
[How to]
Run the script. Press [D] to activate permanently (only on Client operating systems).
...
/force: This option bypasses the message "Windows is also permanently activated." and also force installs a generic key, even if one is already installed.
/pkey: Used for specifying product key to be insalled

Example of syntax:
EzHWID.cmd /dl /silent /force /pkey P42PH-HYD6B-Y3DHY-B79JH-CT8YK
